...
<p id="last" style={{ position: 'fixed', bottom: 0, width: '100%', textAlign: 'center', backgroundColor: '#fff', color: '#28a745', padding: '11px 0' }}>&copy; 2023 Data Marketplace. All rights reserved.</p>
